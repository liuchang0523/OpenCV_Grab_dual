...
#include "../OpenCV_Grab_dual/MyLineEdit.h"
...
void MyLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->editingFinished((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLineEdit::editingFinished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyLineEdit::editingFinished(QString _t1)
{
