...
#include "../OpenCV_Grab_dual/MyLabel.h"
...
QT_MOC_LITERAL(1, 8, 18), // "labelDoubleClicked"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "MyLabel\0labelDoubleClicked\0"
};
...
void MyLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->labelDoubleClicked(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLabel::labelDoubleClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyLabel::labelDoubleClicked()
{
